...
import "./DashviewSCREEN01.css";

function DashviewSCREEN01(props) {
  const {
    itemName1,
    itemName2,
    label1,
  ...
  return (
    <div className="container-center-horizontal">
      <div className="dashview-screen01 screen">
...
export default DashviewSCREEN01;
