  ...
  return (
    <div className="pages">
      <Arrow
        ...
        className={arrow1Props.className}
      />
      <PageNumber42 />
      ...
      <div className="page-number">
        <div className="placeholder-text-71 neuehaasgroteskdisplaystd-regular-normal-sonic-silver-14px">10</div>
      </div>
      <Arrow
        atomsIcon2019Close1={arrow2Props.atomsIcon2019Close1}
        atomsIcon2019Close2={arrow2Props.atomsIcon2019Close2}
        className={arrow2Props.className}
      />
    </div>
  );
}
